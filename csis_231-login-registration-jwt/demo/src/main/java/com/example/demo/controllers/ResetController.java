...
public class ResetController {
     ...
     * any previously stored e-mail from {@link com.example.demo.security.TempAuth#resetEmail}
     ...
     * {@link com.example.demo.api.AuthApi#resetWithCode(String, String, String)}
    ...
    public void onReset() {
        try {
            ...
            AuthApi.resetWithCode(email, c, p);
